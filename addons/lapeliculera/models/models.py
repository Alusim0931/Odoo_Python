...
class lapeliculera_pelicula(models.Model):
     ...
     name = fields.Char(string="Titulo",requiered=True,help="Introduce el titulo de la pelicula")
     director = fields.Char(string="Director",requiered=True,help="Introduce el director")
...
class lapeliculera_genero(models.Model):
    ...
    name = fields.Char(string= "Género",requiered=True,help="Introduce el de la película")
